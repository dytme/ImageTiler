...
void loadStorefrontAssets() {
  ...
  brickWall = new  TiledImage(this, brickWallTexture, 0, 0, width, height, 100, 100);
  planksWall = new  TiledImage(this, planksWallTexture, 0, height-400, width, 400, 250, 250);
  panelJoint = new  TiledImage(this, panelJointTexture, 70, 80, 1140, 85, "", 9, 1);
  christmasGarland = new  TiledImage(this, christmasGarlandTexture, panelJoint.xPos, 0, panelJoint.xSize, 85, "y", 6, 1);
  shelfGarland = new  TiledImage(this, christmasGarlandTexture, 0, height-100, width/2, 85, "y", 5, 1);
  secondFloorWindow = new  TiledImage(this, secondFloorWindowTexture, 96, -100, width-98*2, 237, "", 2, 1);

  leftPillar = new  TiledImage(this, pillarTexture, 0, 0, 95, windowOffset, 35, 35);
  middlePillar = new  TiledImage(this, pillarTexture, leftPillar.xSize+520, 0, 120, windowOffset, 35, 35);
  rightPillar = new  TiledImage(this, pillarTexture, width-95, 0, 95, windowOffset, 35, 35);
